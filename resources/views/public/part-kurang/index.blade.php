    ...
    <div class="page-inner">
        ...
        <div id="sectionInputMode">
            ...
            <div class="card shadow-sm border-0 mb-3">
                <div class="card-body p-3">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <span class="step-indicator bg-primary text-white">
                            <i class="fas fa-user-check me-1"></i>Langkah 1: Scan QR Member Pelapor
                        </span>
            ...
            <div class="card shadow-sm border-0 mb-3" id="kanbanScanCard" style="display:none;">
                <div class="card-body p-3">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <span class="step-indicator bg-success text-white">
        ...
        <div id="sectionReceiveMode" style="display:none;">
            <div class="card shadow-sm border-0 mb-3">
                <div class="card-body p-4 text-center">
                    ...
                    <h5 class="fw-bold mb-2">Scan QR Member untuk Membuka Laporan Part Kurang Anda</h5>
                    <p class="text-muted small mb-3">Sistem akan membuka modal berisi seluruh daftar part kurang yang pernah diajukan oleh NIK Anda dan dapat langsung dikonfirmasi diterima.</p>
                    ...
                    <div class="col-12 col-md-8">
                        <div class="d-flex flex-wrap justify-content-md-end gap-2 align-items-center">
                            <div class="btn-group btn-group-sm filter-btn-group" role="group">
                                <button type="button" class="btn btn-outline-primary active" data-status="pending">Pending</button>
                                <button type="button" class="btn btn-outline-primary" data-status="oke">Oke / Diterima</button>
                                <button type="button" class="btn btn-outline-primary" data-status="all">Semua</button>
                            </div>
                            <div style="min-width: 180px;">
                                <input type="text" id="filterSearch" class="form-control form-control-sm" placeholder="Cari Seq / Tipe / NIK / Part...">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body bg-light p-3">
                <div class="d-flex justify-content-between align-items-center mb-2 px-1">
                    ...
                    <div class="btn-group btn-group-sm" role="group">
                        <button type="button" class="btn btn-outline-primary btn-sm modal-filter-btn active" data-filter="pending">Pending</button>
                        <button type="button" class="btn btn-outline-primary btn-sm modal-filter-btn" data-filter="oke">Sudah Diterima</button>
            ...
            <div class="modal-footer py-2">
                <small class="text-muted me-auto"><i class="fas fa-info-circle me-1"></i>Setelah selesai, tutup modal untuk scan member berikutnya.</small>
...
<script>
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.success) {
                    ...
                    $('#modalMemberSubtitle').text(member.nama + ' (NIK: ' + member.nik + ') &bull; ' + res.pending_count + ' Pending');
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        if (resp.success) {
                            ...
                            // Update cached data
                            $.each(cachedModalReports, function(i, it) {
                                if (it.Id_Part_Kurang === id) {
                                    it.Status = 'oke';
                                    it.Received_Time = 'Baru saja';
                                }
                            });

                            // Re-render modal reports
                            renderModalReports();
    ...
    // =========================================================================
    function resetAndLoadRecentList() {
        currentPage = 1;
        hasMoreData = true;
        isLoadingMore = false;
        ...
        fetchRecentList(currentPage, true);
    }
    ...
    function fetchRecentList(page, isReset) {
        isLoadingMore = true;
