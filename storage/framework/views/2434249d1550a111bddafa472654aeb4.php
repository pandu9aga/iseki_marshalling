        ...
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-3">
                        <label>Date</label>
                        <input type="date" id="filter_date" class="form-control form-control-sm" value="<?php echo e($today); ?>">
                    </div>
...
<script>
    ...
    $(document).ready(function() {
        var table = $('#reportEmptyTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(url('admin/report-empty')); ?>",
                data: function(d) {
    ...
    function showCarousel() {
        stopCarousel();
        var date = $('#filter_date').val() || '<?php echo e($today); ?>';

        $.getJSON('<?php echo e(url("admin/report-empty/carousel")); ?>', { date: date }, function(data) {
            carouselData = data;
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\iseki_marshalling\resources\views/admin/records/report-empty.blade.php ENDPATH**/ ?>