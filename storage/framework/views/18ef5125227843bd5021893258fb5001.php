...
<div class="container">
    <div class="page-inner">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <form action="<?php echo e(route('admin.punishments.store')); ?>" method="POST" class="row g-2 align-items-end" id="addPunishmentForm">
                    <?php echo csrf_field(); ?>
...
<script>
    $(document).ready(function() {
        var table = $('#punishmentsTable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(url('admin/punishments')); ?>",
            columns: [
        ...
        $('#memberNameInput').on('input', function() {
            ...
            searchTimer = setTimeout(function() {
                $.ajax({
                    url: "<?php echo e(route('admin.punishments.search')); ?>",
                    data: { q: q },
                    type: 'GET',
...
item.on('click', function() {
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            if (confirm('Hapus NIK dari daftar punishment?')) {
                $.ajax({
                    url: "<?php echo e(url('admin/punishments')); ?>/" + id,
                    type: 'DELETE',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\iseki_marshalling\resources\views/admin/punishments/index.blade.php ENDPATH**/ ?>