                ...
                <form id="filterForm" class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="filter_member" class="form-select form-select-sm">
                            ...
                            <option value="<?php echo e($member->id); ?>"><?php echo e($member->nama); ?></option>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="filter_area" class="form-select form-select-sm">
                            ...
                            <?php if($area): ?>
                            <option value="<?php echo e($area); ?>"><?php echo e(ucwords(str_replace('_', ' ', $area))); ?></option>
                            <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
...
<script>
    $(document).ready(function() {
        var canDelete = <?php echo json_encode($canDelete ?? false, 15, 512) ?>;
        var tableColumns = [
        ...
        var table = $('#recordsTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(url('admin/records')); ?>",
                data: function(d) {
        ...
        $(document).on('click', '.delete-btn', function(e) {
            ...
            if (confirm('Apakah Anda yakin ingin menghapus record ini beserta seluruh list part-nya?')) {
                $.ajax({
                    url: "<?php echo e(url('admin/records')); ?>/" + id,
                    type: 'DELETE',
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\iseki_marshalling\resources\views/admin/records/index.blade.php ENDPATH**/ ?>